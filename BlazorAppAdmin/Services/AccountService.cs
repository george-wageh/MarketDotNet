    ...
    public class AccountService
    {
        ...
        public async Task<ResponseDTO<string>> Login(UserLoginDTO userLoginDTO)
        {
            try
            {
                ...
                var response = await HttpClient.PostAsJsonAsync<UserLoginDTO>("api/AccountAdmin/login", userLoginDTO);
        ...
        public async Task<ResponseDTO<object>> RegisterAsync(UserRegisterDTO userRegisterDTO) {
            ...
            {
                var HttpClient = HttpClientFactory.CreateClient("Client");
                var response = await HttpClient.PostAsJsonAsync("api/AccountAdmin/register", userRegisterDTO);
